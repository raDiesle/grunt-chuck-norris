module.exports = function(grunt) {
    grunt.registerTask('chuckNorris', 'About Chuck Norris', function() {
        var defaults = [
        ...
        var abouts = grunt.config('chuckNorrisAbouts') || defaults;
        var index = Math.floor(Math.random() * abouts.length);
        grunt.log.writeln(abouts[index]);
    });
};